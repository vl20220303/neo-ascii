...
def main():
    ...
    effect_mask = generate_pulsing_mask(image_dims=ascii_scaled_dims(dimensions[0], dimensions[1]), density=0.95, background=0.6)
...
def pipeline(image, ascii_mask, effect_mask):
    ...
    color_mask = generate_color_mask(image=color_mask, map=[(230,255,230), (-200,255,-200), (-200,255,-200)])
