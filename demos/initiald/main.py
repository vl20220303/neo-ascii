...
def pipeline(image, ascii_mask, effect_mask):
    ...
    color_mask = map(image=oversaturate(brighten(image, 100), 50), map=[(255, 0, 0), (0, 255, 0), (0, 0, 255)])
    return assemble(color_mask=color_mask, activation_mask=activation_mask, use_ascii_activation="default")
